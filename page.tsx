          ...
          >
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 sm:gap-10 mb-12 sm:mb-16 lg:mb-20">
              <div className="max-w-3xl">
                ...
                <p className="text-white/60 text-base sm:text-lg lg:text-xl leading-relaxed max-w-2xl">
                  Tap the chart on mobile or hover on desktop to explore each allocation.
                </p>
              </div>
              <div className="w-full max-w-full sm:w-auto rounded-[28px] sm:rounded-[32px] border border-brand-red/30 bg-brand-red/10 px-5 sm:px-8 lg:px-10 py-5 sm:py-7 lg:py-8 red-glow overflow-hidden">
                <p className="text-[11px] text-white/40 uppercase tracking-[0.4em] font-black mb-3">Total Supply</p>
                <p className="max-w-full text-[clamp(2.25rem,11vw,3.75rem)] font-display font-black text-brand-red-glow tracking-tighter leading-none break-words">
